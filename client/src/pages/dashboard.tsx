  ...
  return (
    <Layout>
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="screenshot">{t('dashboard.screenshotEvidence')}</Label>
            ...
            <DialogFooter>
              <Button onClick={handleClaimPoints} data-testid="button-submit-claim">{t('dashboard.submitClaim')}</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
      ...
      <Card className="col-span-full bg-card/30 backdrop-blur-md border-border/50">
        <CardHeader>
          <CardTitle className="font-display text-xl">{t('dashboard.myRequestsHistory')}</CardTitle>
